...
public class SecurityFilter implements Filter {
	private String noPermissionnPage;
	...
	public void init(FilterConfig config) throws ServletException {
		...
		noPermissionnPage = config.getInitParameter("noPermissionnPage");
		if (noPermissionnPage == null) {
			noPermissionnPage = "/NoPermissionPage.xhtml";
		}
		publicResources.add(noPermissionnPage);
...
//	    System.out.println("Przetwarzana ścieżka: " + request.getServletPath());
//	    System.out.println("Ścieżka dostępu: " + path);
//	    System.out.println("Publiczny zasób: " + publicResources.contains(path));
//	    System.out.println("Uprawnienia dla ścieżki: " + permitions.get(path));
...
//						System.out.println("Uprawnienia dla ścieżki: " + permitions.get(path));
		...
		if (!pass) {
			...
			if ("partial/ajax".equals(request.getHeader("Faces-Request"))) {
				...
				request.getServletContext().getRequestDispatcher(noPermissionnPage).forward(request, response);
			}
